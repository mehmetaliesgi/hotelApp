...
ActiveRecord::Schema[7.0].define(version: 2022_12_30_105726) do
  ...
  create_table "hotel_users", id: :bigint, default: -> { "nextval('users_id_seq'::regclass)" }, force: :cascade do |t|
    t.string "name"
    t.string "surname"
    t.string "email"
    t.bigint "tckn"
